...
<head>
    <meta charset="utf-8">
    <title>R&eacute;ponse &agrave; votre demande</title>
</head>
<body style="margin:0; padding:24px; background:#f5f7fb; font-family:Arial, Helvetica, sans-serif; color:#1f2937;">
    <div style="max-width:680px; margin:0 auto; background:#ffffff; border:1px solid #e5e7eb; border-radius:16px; overflow:hidden;">
        <div style="background:#1c203d; color:#ffffff; padding:24px;">
            <h1 style="margin:0; font-size:24px; line-height:1.3;">R&eacute;ponse &agrave; votre demande</h1>
        </div>

        <div style="padding:24px;">
            <p style="margin:0 0 16px; font-size:15px; line-height:1.7;">
                @if (!empty($recipientName))
                    Bonjour Mr {{ $recipientName }},
                @else
                    Bonjour,
                @endif
            </p>
            ...
            <p style="margin:0 0 16px; font-size:15px; line-height:1.7;">
                Une r&eacute;ponse a &eacute;t&eacute; apport&eacute;e &agrave; votre demande.
            </p>

            <div style="background:#f8fafc; border:1px solid #e5e7eb; border-radius:12px; padding:16px; margin:0 0 16px;">
                <p style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#6b7280;">Num&eacute;ro de suivi</p>
            ...
            <div style="margin:0 0 16px;">
                <p style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#6b7280;">Contenu de la r&eacute;ponse</p>
            ...
            @if (($attachmentCount ?? 0) > 0)
                <p style="margin:0 0 16px; font-size:14px; line-height:1.7; color:#4b5563;">
                    Des pi&egrave;ces jointes sont incluses dans cet email.
                </p>
            @endif

            <p style="margin:0; font-size:14px; line-height:1.7; color:#4b5563;">
                Cordialement,<br>
                Cellule r&eacute;clamation ANBG
            </p>
        </div>
    </div>
</body>
